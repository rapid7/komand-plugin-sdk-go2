...
func templatesTriggersTrigger_xTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/triggers/trigger_x.template", size: 2780, mode: os.FileMode(420), modTime: time.Unix(1490220031, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
