...
func templatesCmdMainTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/cmd/main.template", size: 9064, mode: os.FileMode(420), modTime: time.Unix(1490639483, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesTriggersTrigger_xTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/triggers/trigger_x.template", size: 2915, mode: os.FileMode(420), modTime: time.Unix(1490639446, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
